...
<body class="d-flex h-100 text-center text-white bg-dark">
	...
	<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
		...
		<main style="margin-left: -180px; width: 1000px;" class="container">
			...
			<p style="height: 20px;">카테고리 - ${menuList[0].categoryName}</p>
			<div class="row mb-2">
						...
						<ul>
							<c:forEach var="menu" items="${menuList}">
								<img style="height: 130px;"
									src="../resources/img/menu/${menu.picture}.jpg">
								<li style="height: 50px; line-height: 100px;">제품명 :
									${menu.name}</li>
								<li style="height: 50px; line-height: 100px;">가격 :
									${menu.price}</li>
								<li
									style="height: 50px; line-height: 100px; margin-bottom: 50px;">재고
									: ${menu.quantity}</li>
							</c:forEach>
						</ul>
					</div>
