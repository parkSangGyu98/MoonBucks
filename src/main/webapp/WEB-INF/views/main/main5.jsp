...
<body class="d-flex h-100 text-center text-white bg-dark">
	...
	<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
		...
		<main style="margin-left: -180px; width: 1000px;" class="container">
			<form id="aTag" action="main5" method="post" style="margin:0;">
				<h1 style="margin-top: 30px;">Take</h1>
				<div class="row mb-2">
					<c:forEach var="take" items="${takeList}" varStatus="status">
						<div style="margin-bottom: 30px;" class="col-md-6">
							<div
								class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
								<img
									src="../resources/img/take/${takePictureList[status.index]}.jpg">
							</div>
				...
				<div class="row mb-2">
					<div class="col-md-6">
						<div
							...
							class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
							<a href="/MoonBucks/controller/main4" class="nav-link hoverStyle">뒤로가기</a>
						</div>
					</div>
				</div>
			</form>
